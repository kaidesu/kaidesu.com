...
export const meta = {
  author: 'Kai',
  date: '2021-08-16',
  title: 'An Introduction to Spaced Repetition',
  description:
    'An introduction to spaced repetition, what it is, how it works, and some examples of its implementation through code.',
}

export default (props) => <ArticleLayout meta={meta} {...props} />

Spaced repetition is an evidence-bsaed learning technique that is usually performed with flashcards.

Newly introduced and more difficult flashcards are shown more frequently, while older and less difficult flashcards are shown less frequently in order to explore the **psychological spacing effect**.
...
Research has shown that spaced repetition "leads to more robust memory formation than does massed training, which involves short or no intervals".
